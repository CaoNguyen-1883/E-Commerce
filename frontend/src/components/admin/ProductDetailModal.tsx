...
import { X, CheckCircle, XCircle, Package, Tag, Star, Eye, ShoppingCart } from "lucide-react";
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <p className="text-xl font-bold text-gray-900">{product.totalStock}</p>
            </div>
        ...
        {/* Actions */}
        {product.status === ProductStatus.PENDING_APPROVAL && !showRejectForm && (
