...
public class ProductController {
    ...
    @Operation(
            ...
            description = "Get all approved products with pagination (Public)"
    )
    @GetMapping
    ...
    @Operation(
            ...
            description = "Get products filtered by status (Staff/Admin only)"
    )
    ...
    public ResponseEntity<ApiResponse<Page<ProductSummaryDto>>> getProductsByStatus(
            ...
            @PageableDefault(size = 20) Pageable pageable) {
        Page<ProductSummaryDto> products = productService.getProductsByStatus(status, pageable);
        return ResponseEntity.ok(ApiResponse.success("Products retrieved successfully", products));
    }
